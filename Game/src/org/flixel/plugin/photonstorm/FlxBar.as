...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxBar extends FlxSprite
	{
		 ...
		 */
		public function FlxBar(x:int, y:int, direction:uint = FILL_LEFT_TO_RIGHT, width:int = 100, height:int = 10, parentRef:* = null, variable:String = "", min:Number = 0, max:Number = 100, border:Boolean = false, 
      fillColor:int = 0xff00F400, emptyColor:int = 0xff005100):void
		{
			super(x, y);
			...
			createFilledBar(emptyColor, fillColor, border);
